...
export function useProvisionAccount() {
    ...
    return useMutation<
        Awaited<ReturnType<typeof provisionAccount>>,
        ApiError,
        ProvisionPayload
    >({
...
export function useRenameAccount() {
    ...
    const { toast } = useToast();
    return useMutation<
        Awaited<ReturnType<typeof renameAccount>>,
        ApiError,
    ...
    >({
        ...
        onError: (err) => {
            toast({
                type: 'error',
                message: err.message || 'Failed to rename account',
            });
        },
    });
}
...
export function useFreezeAccount() {
    ...
    >({
        ...
        onError: (err) => {
            toast({
                type: 'error',
                message: err.message || 'Failed to freeze account',
            });
        },
    });
}
...
export function useUnfreezeAccount() {
    ...
    >({
        ...
        onError: (err) => {
            toast({
                type: 'error',
                message: err.message || 'Failed to unfreeze account',
            });
        },
    });
}
