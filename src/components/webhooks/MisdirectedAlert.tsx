...
export function MisdirectedAlert({ account, transaction, onAllocate, onReturn, className }: MisdirectedAlertProps) {
  ...
  return (
    ...
    >
      <p className="text-sm mb-3">
        A payment of <strong>{formatCurrency(transaction.amount)}</strong> from{' '}
        <strong>{transaction.senderName}</strong> may have been sent to the wrong account (
