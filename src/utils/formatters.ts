...
export function truncateString(str: string | null | undefined, maxLength = 30): string {
  if (!str) return ''
...
export function formatAccountNumber(number: string | number | null | undefined): string {
  if (!number) return ''
