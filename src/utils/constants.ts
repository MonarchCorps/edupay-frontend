...
import type { AccountStatus, KycTier, TransactionDirection, TransactionStatus, WebhookEventType } from '../types'
...
export const ACCOUNT_STATUSES: Record<AccountStatus, { label: string; colour: string; tremorColour: Color }> = {
...
export const TRANSACTION_DIRECTIONS: Record<TransactionDirection, { label: string; tremorColour: Color }> = {
  credit: { label: 'Credit', tremorColour: 'green' },
  debit:  { label: 'Debit',  tremorColour: 'red'   },
}

export const TRANSACTION_STATUSES: Record<TransactionStatus, { label: string; tremorColour: Color }> = {
...
export const NAV_ITEMS: Array<{ label: string; path: string; icon: string; bottom?: boolean }> = [
