...
const ENDPOINTS: Endpoint[] = [
    {
        method: 'POST',
        path: '/accounts',
        description: 'Provision a new virtual account',
        request: `{
  ...
  "limit": 20
    ...
    },
    {
        method: 'GET',
        path: '/accounts/:id',
        description: 'Retrieve a single virtual account',
        request: '',
        response: `{
  "id": "acc_001",
  "accountNumber": "0031234567",
  ...
  "lastCreditAt": "2026-06-22T14:30:00.000Z"
    ...
    },
    {
        ...
        description: 'Close an account and sweep balance',
        request: '',
    ...
    },
    {
        ...
        description: 'Get ledger statement with running balance',
        request: '',
        response: `[
  { "id": "txn_001", "direction": "credit", "amount": 5000000, "runningBalance": 5000000, ... }
    ...
    },
    {
        ...
        request: '',
        response:
            '{ "id": "wh_001", "processed": true, "processedAt": "2026-06-23T10:01:00.000Z" }',
    },
];
...
const WEBHOOK_EVENTS_TABLE = [
    {
        ...
        when: 'Inbound transfer credited to a virtual account',
    },
    {
        event: 'transfer.debit',
        when: 'Outbound transfer debited from a virtual account',
    },
    {
        event: 'account.kyc_update',
        when: 'KYC tier changed for a virtual account',
    },
    {
        event: 'account.frozen',
        when: 'Virtual account frozen (manual or automated)',
    },
...
const ERROR_CODES = [
    {
        ...
        http: 404,
        meaning: 'No account with the given ID',
        action: 'Check the account ID',
    },
    {
        code: 'INSUFFICIENT_BALANCE',
        http: 422,
        meaning: 'Debit exceeds available balance',
        action: 'Top up before debiting',
    },
    {
        code: 'ACCOUNT_FROZEN',
        http: 403,
        meaning: 'Account is frozen — no transfers allowed',
        action: 'Unfreeze account first',
    },
    {
        code: 'ACCOUNT_CLOSED',
        http: 410,
        meaning: 'Account has been permanently closed',
        action: 'Provision a new account',
    },
    {
        code: 'INVALID_API_KEY',
        http: 401,
        meaning: 'API key is missing or invalid',
        action: 'Regenerate key in Settings',
    },
    {
        code: 'VALIDATION_ERROR',
        http: 400,
        meaning: 'Request body failed validation',
        action: 'Check the error.details field',
    },
];
...
export default function ApiDocs() {
    return (
        <div className="space-y-8 max-w-3xl">
            <PageHeader
                title="API Reference"
                subtitle="EduPay DVA Infrastructure API — v1.0"
            />
